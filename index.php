   ...
   <?php include 'header.php' ?>
    ...
    <div class="container-fluid p-0 content">
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="5000">
                    <img src="images/car_1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="images/car_2.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 box-item">
                    <div class="card text-start">
                        <img class="p-3 mx-auto" src="images/car-icon.png">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3 box-item">
                    <div class="card text-start">
                        <img class="p-3 mx-auto" src="images/meter-icon.png" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3 box-item">
                    <div class="card text-start">
                        <img class="p-3 mx-auto" src="images/accessories-icon.png" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3 box-item">
                    <div class="card text-start">
                        <img class="p-3 mx-auto" src="images/wheel-icon.png" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Get accessories for <br> all cars</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <div class="row box">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-5 position-relative box-1">
                        <div class="img text-start">
                            <img class="rounded-3" src="images/collection-img1.webp" alt="">
                        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-5 position-relative box-2">
                        <div class="img text-end">
                            <img class="rounded-3" src="images/collection-img2.webp" alt="">
                        </div>
        ...
        <div class="slick-app test">
            <div class="item">
                <img src="images/icon-parts.png" alt="">
                <span>Phụ tùng</span>
                <a class="btn" href="#">Xem Ngay</a>
            </div>
            <div class="item">
                <img src="images/icon-interior.png" alt="">
                <span>Nội thất</span>
                <a class="btn" href="#">Xem Ngay</a>
            </div>
            <div class="item">
                <img src="images/icon-exterior.png" alt="">
                <span>Ngoại thất</span>
                <a class="btn" href="#">Xem Ngay</a>
            </div>
            <div class="item">
                <img src="images/icon-lighting.png" alt="">
                <span>Đèn</span>
                <a class="btn" href="#">Xem Ngay</a>
            </div>
            <div class="item">
                <img src="images/icon-wheels.png" alt="">
                <span>Bánh xe</span>
                <a class="btn" href="#">Xem Ngay</a>
            </div>
        </div>
        ...
        <div class="featured-products container-fluid">
            ...
            <div class="row">
                <div class="col-6 col-sm-6 col-md-6 col-lg-3 box-item">
                    <div class="thumnail-sp">
                        <img src="images/den-bi-xenon4.jpg" width="100%" alt="">
                    </div>
                    <div class="name-sp">Đèn ô tô</div>
                    <div class="price-sp">1.300.000 VNĐ</div>
                    <div class="start-sp">
        ...
        <div class="banner d-flex justify-content-between gap-3">
            <div>
                <img src="images/725x560-1.webp" width="100%" alt="">
            </div>
            <div>
                <img src="images/410x560.webp" width="100%" alt="">
            </div>
            <div>
                <img src="images/725x560-2.webp" width="100%" alt="">
            </div>
        </div>
        ...
        <div class="blog-news">
            ...
            <div class="blog-post d-flex row p-3">
                <div class="card col-sm-6 col-md-4 col-lg-4">
                    <div class="content-post">
                        <div class="test-img-1">
                            <img src="images/blog-1.jpg" class="card-img-top img-fluid" alt="...">
                        </div>
                        <div class="card-body">
                ...
                <div class="card col-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="content-post">
                        <div class="test-img-1">
                            <img src="images/blog-2.jpg" class="card-img-top img-fluid" alt="...">
                        </div>
                        <div class="card-body">
                            <div class="car-body-title">
                ...
                <div class="card col-sm-6 col-md-4 col-lg-4">
                    <div class="content-post">
                        <div class="test-img-1">
                            <img src="images/blog-3.jpg" class="card-img-top img-fluid" alt="...">
                        </div>
                        <div class="card-body">
                            <div class="car-body-title">
                                <a href="#">Eyes on the road</a>
